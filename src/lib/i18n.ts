...
const zh: UI = {
  ...
  heroTitle2: "是否暴露在风险中?",
  heroDesc:
    "一份包含 39 个问题的自我评估,用于衡量贵组织的数据脆弱性。专为非技术高管设计。保密。约需 5 分钟。",
  start: "开始评估",
  features: [
    { title: "保密", desc: "数据不会发送或存储。您的答案仅保留在您的浏览器中。" },
    { title: "客观评分", desc: "6 个关键领域共 195 分。" },
  ...
  securliContact: "如对以上服务有兴趣,欢迎电邮至 info@10gtechnology.com",
  contactCtaTitle: "需要更多协助?",
  contactCtaBody: "如需更多网络安全服务或资讯,欢迎电邮至 info@10gtechnology.com,我们的团队乐意为您服务。",
  securliRecs: [
    {
...
const ja: UI = {
  ...
  heroDesc:
    "組織のデータ脆弱性を評価するための39問のセルフアセスメント。技術者でない経営層向けに設計。機密保持。所要時間は約5分。",
  start: "アセスメントを開始",
  features: [
    { title: "機密性", desc: "データは送信も保存もされません。回答はブラウザ内に留まります。" },
    { title: "公正な採点", desc: "6つの重要領域、合計195点。" },
  ...
  securliContact: "上記のサービスにご興味があれば info@10gtechnology.com までメールください",
  contactCtaTitle: "さらなるサポートが必要ですか?",
  contactCtaBody: "サイバーセキュリティに関するサービスや情報については info@10gtechnology.com までお問い合わせください。チームが喜んでお手伝いします。",
  securliRecs: [
    {
